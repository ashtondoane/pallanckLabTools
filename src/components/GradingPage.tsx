...
function GradingPage() {
  ...
  const [flyPoints, setFlyPoints] = React.useState<{ x: number; y: number }[]>(
    []
  ); //stored as percentages of image height for rendering purposes
  ...
  return (
    <div className="container-fluid px-5">
      <div className="row">
        <h3>Score Images</h3>
        <text className="fw-light">Don't worry about noting data yet - it will be summed up for you at the end.</text>
      </div>
            ...
            ? flyPoints.map((p) => (
                <Draggable
                  ...
                  onStop={(e: DraggableEvent) => {
                    ...
                    console.log(
                      1 -
                        ((e as MouseEvent).clientY - imgPos[1]) / imgDim[1] +
                        "%"
                    );
                  }}
                >
